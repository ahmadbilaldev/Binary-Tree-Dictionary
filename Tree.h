...
public:
	...
	Tree& insert(string word, string synonym, string defination); //To insert a new word in dictionary
	...
	void showSynonymAndDefinition(string word); //To show synonyms and definition of a word
